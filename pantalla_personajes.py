...
class Personajes(pantallas.PantallaJugador):
    def __init__(self, gestor):
        ...
        self.elegido = None#iniciar con ninguno

        self.personaje1 = pygame.image.load("Imagenes/Personajes/CuyOriginal.png")
        self.posX_P1,self.posY_P1=150,100
        self.seleccionar1 = boton.Button(150,200,140,40, text = 'Cuy')

        self.personaje2 = pygame.image.load("Imagenes/Personajes/GallitoOriginal.png")
        self.posX_P2,self.posY_P2=150,250
        self.seleccionar2 = boton.Button(150,350,140,40, text = 'Gallito')

        self.personaje3 = pygame.image.load("Imagenes/Personajes/LlamaOriginal.png")
        self.posX_P3,self.posY_P3=150,400
        self.seleccionar3 = boton.Button(150,500,140,40, text = 'Llama')

        self.personaje4 = pygame.image.load("Imagenes/Personajes/PerroOriginal.png")
...
#va a personalizar
    def update(self):
        if self.seleccionar1.active:
            self.elegido = self.personaje1
            self.gestor.pantalla_actual.ir_personalizar()
