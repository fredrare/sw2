...
class PantallaPersonalizar(pantallas.PantallaJugador):
    def __init__(self, gestor):
        self.gestor = gestor
        pygame.display.set_caption("personalizarpersonaje")
        ...
        self.personaje = pygame.image.load("Imagenes/Personajes/CuyOriginal.png") #para probar
        #self.gestor.pantalla_personajes(self.elegido)  #que jale al personaje elegido
#Personaje CUY
        self.personajeCuy = pygame.image.load("Imagenes/Personajes/CuyOriginal.png")
        self.posX_PC,self.posY_PC=150,100 #Posicion personaje cuy
        self.seleccionarCuy = boton.Button(150,200,140,40, text = 'CuyBase')

        self.personajeCuy1 = pygame.image.load("Imagenes/Personajes/cuy-v1.png")
        self.posX_PC1,self.posY_PC1=150,250
        self.seleccionarC1 = boton.Button(150,350,140,40, text = 'CuyV1')

        self.personajeCuy2 = pygame.image.load("Imagenes/Personajes/cuy-v2.png")
        self.posX_PC2,self.posY_PC2=150,400
        self.seleccionarC2 = boton.Button(150,500,140,40, text = 'CuyV2')

        self.personajeCuy3 = pygame.image.load("Imagenes/Personajes/cuy-v3.png")
        self.posX_PC3,self.posY_P4C3500,100
        self.seleccionarC3 = boton.Button(500,200,140,40, text = 'CuyV3')

#Personaje GALLITO
        self.personajeGallito = pygame.image.load("Imagenes/Personajes/GallitoOriginal.png")
        ...
        self.personajeGallito1 = pygame.image.load("Imagenes/Personajes/Gallito-v1.png")
        self.posX_PG1,self.posY_PG1=150,250
        self.seleccionarG1 = boton.Button(150,350,140,40, text = 'GallitoV1')

        self.personajeGallito2 = pygame.image.load("Imagenes/Personajes/Gallito-v2.png")
        self.posX_PG2,self.posY_PG2=150,400
        self.seleccionarG2 = boton.Button(150,500,140,40, text = 'GallitoV2')

        self.personajeGallito3 = pygame.image.load("Imagenes/Personajes/Gallito-v3.png")
        self.posX_PG3,self.posY_PG3=500,100
        self.seleccionarG3 = boton.Button(500,200,140,40, text = 'GallitoV3')

#Personaje LLAMA
        self.personajeLlama = pygame.image.load("Imagenes/Personajes/LlamaOriginal.png")
        ...
        self.personajeLlama1 = pygame.image.load("Imagenes/Personajes/Llama-v1.png")
        self.posX_PL1,self.posY_PL1=150,250
        self.seleccionarL1 = boton.Button(150,350,140,40, text = 'LlamaV1')

        self.personajeLlama2 = pygame.image.load("Imagenes/Personajes/Llama-v2.png")
        self.posX_PL2,self.posY_PL2=150,400
        self.seleccionarL2 = boton.Button(150,500,140,40, text = 'LlamaV2')

        self.personajeLlama3 = pygame.image.load("Imagenes/Personajes/Llama-v3.png")
...
#Personaje PERRO
        self.personajePerro = pygame.image.load("Imagenes/Personajes/PerroOriginal.png")
        ...
        self.personajePerro1 = pygame.image.load("Imagenes/Personajes/Perro-v1.png")
        self.posX_PP1,self.posY_PP1=150,250
        self.seleccionarP1 = boton.Button(150,350,140,40, text = 'PerroV1')

        self.personajePerro2 = pygame.image.load("Imagenes/Personajes/Perro-v2.png")
        self.posX_PP2,self.posY_PP2=150,400
        self.seleccionarP2 = boton.Button(150,500,140,40, text = 'PerroV2')

        self.personajePerro3 = pygame.image.load("Imagenes/Personajes/Perro-v3.png")
    ...
    def update(self):
        ...
        #    self.gestor.pantalla_actual.ir_sala()
        if self.personaje = pygame.image.load("Imagenes/Personajes/CuyOriginal.png") #sicuy
            if self.seleccionarC1.active: #si se selecciona la primera version
                ...
                #if self.personajeCuy.active:
                    #self.gestor.pantalla_actual.ir_juego()
        elif self.personaje = pygame.image.load("Imagenes/Personajes/GallitoOriginal.png")#si el personaje es gallo
            if self.seleccionarG1.active:
                ...
                #if self.personajeGallito.active:
                    #self.gestor.pantalla_actual.ir_juego()
        elif self.personaje = pygame.image.load("Imagenes/Personajes/PerroOriginal.png") #si el personaje es perro
            if self.seleccionarP1.active:
                ...
                #if self.personajePerro.active:
                    #self.gestor.pantalla_actual.ir_juego()
        elif self.personaje = pygame.image.load("Imagenes/Personajes/LlamaOriginal.png") #si el personaje es Llama
    ...
    def render(self):
        ...
        if self.personaje = pygame.image.load("Imagenes/Personajes/CuyOriginal.png") #si el personaje es cuy
        ...
        if self.situado:
            if self.personaje = pygame.image.load("Imagenes/Personajes/CuyOriginal.png")
            ...
            elif self.personaje = pygame.image.load("Imagenes/Personajes/GallitoOriginal.png")
            ...
            elif self.personaje = pygame.image.load("Imagenes/Personajes/LlamaOriginal.png")
            ...
            elif self.personaje = pygame.image.load("Imagenes/Personajes/PerroOriginal.png")
